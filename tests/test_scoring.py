...
def test_format_pred_display_no_legacy_codes():
    ...
    assert format_pred_display("A", team_a="Canada", team_b="Paraguay", name_to_fifa=fifa) == "🇨🇦 Canada thắng"
    assert format_pred_display("B", team_a="Canada", team_b="Paraguay", name_to_fifa=fifa) == "🇵🇾 Paraguay thắng"
    assert format_pred_display("D") == "🤝 Hòa"
    assert format_pred_display("L", team_a="Canada", team_b="Paraguay", name_to_fifa=fifa) == "🇵🇾 Paraguay thắng"
    assert format_pred_display("W", team_a="Canada", team_b="Paraguay", name_to_fifa=fifa) == "🇨🇦 Canada thắng"
